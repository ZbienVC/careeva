...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prompt = [
      ...
      `4. Keep total body under 170 words — short and specific beats long and generic. Recruiters skim; every sentence must earn its place.`,
      `5. Writing tone: ${toneWords}. Avoid these words: ${avoidWords}. No filler openers ("I am writing to express..."), no clichés ("team player", "fast-paced environment").`,
      '',
      ...
      'PARAGRAPH 1 (1-2 sentences): Why this specific role at this specific company. Reference one concrete specific from the job description.',
      'PARAGRAPH 2 (2-3 sentences): The single most relevant experience from the profile. Real job title, real company, real accomplishment, direct overlap with the job requirements.',
      'PARAGRAPH 3 (1-2 sentences): 2-3 specific skills/technologies that appear in BOTH the job description AND the profile. Be explicit.',
