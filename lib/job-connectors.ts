...
const COMPANY_NAMES: Record<string, string> = {
  ...
  'huggingface': 'Hugging Face', 'runway': 'Runway', 'runwayml': 'Runway',
  'mistral': 'Mistral AI', 'perplexity': 'Perplexity AI', 'dbt-labs': 'dbt Labs',
  ...
  'gleanwork': 'Glean', 'arizeai': 'Arize AI', 'langchain': 'LangChain',
  'llamaindex': 'LlamaIndex', 'modal': 'Modal', 'replicate': 'Replicate',
  'together': 'Together AI', 'fireworks': 'Fireworks AI', 'groq': 'Groq',
  'cerebras': 'Cerebras', 'adept': 'Adept', 'inflection': 'Inflection AI',
  'characterai': 'Character.AI', 'harvey': 'Harvey', 'sierra': 'Sierra',
  'imbue': 'Imbue', 'poolside': 'Poolside', 'cognition': 'Cognition',
  'factory': 'Factory', 'devin': 'Cognition (Devin)', 'codegen': 'Codegen',
  'tabnine': 'Tabnine', 'wandb': 'Weights & Biases', 'palantir': 'Palantir',
  'deepgram': 'Deepgram', 'bland': 'Bland AI', 'decagon': 'Decagon',
  'lindy': 'Lindy', 'pinecone': 'Pinecone', 'resend': 'Resend',
  'clerk': 'Clerk', 'inngest': 'Inngest', 'workos': 'WorkOS',
  'attio': 'Attio', 'tinybird': 'Tinybird', 'AlephAlpha': 'Aleph Alpha',
  'DeepL': 'DeepL', 'n8n': 'n8n', 'zapier': 'Zapier',
  'synthesia': 'Synthesia', 'faculty': 'Faculty AI', 'lovable': 'Lovable',
  'legora': 'Legora', 'photoroom': 'Photoroom', 'lakera.ai': 'Lakera',
  'cradlebio': 'Cradle Bio', 'causaly': 'Causaly', 'qonto': 'Qonto',
  'forto': 'Forto', 'pigment': 'Pigment', 'vinted': 'Vinted',
  'spotify': 'Spotify', 'clarity-ai': 'Clarity AI',
  'humeai': 'Hume AI', 'blackforestlabs': 'Black Forest Labs',
  'speechmatics': 'Speechmatics', 'isomorphiclabs': 'Isomorphic Labs',
  'physicsx': 'PhysicsX', 'wayve': 'Wayve', 'amplemarket': 'Amplemarket',
  ...
  'runpod': 'RunPod', 'temporal': 'Temporal', 'factorial': 'Factorial',
  'scandit': 'Scandit', 'polyai': 'PolyAI', 'parloa': 'Parloa',
};
